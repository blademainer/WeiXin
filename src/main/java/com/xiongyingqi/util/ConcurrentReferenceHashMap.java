...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    /**
     * Factory method that returns the {@link ConcurrentReferenceHashMap.ReferenceManager}. This method will be
     * called once for each {@link ConcurrentReferenceHashMap.Segment}.
     *
    ...
    /**
     * A reference to an {@link ConcurrentReferenceHashMap.Entry} contained in the map. Implementations are usually
